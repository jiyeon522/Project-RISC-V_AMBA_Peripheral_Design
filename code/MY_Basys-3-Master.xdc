...
set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { FND_comm[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=an[0]
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { FND_comm[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=an[1]
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { FND_comm[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=an[2]
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { FND_comm[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=an[3]
